...
public:
	api_ping(local_peer &local_peer, api_connection &connection);
	~api_ping();
...
public:
	api_store_file(local_peer &local_peer, api_connection &connection);
	~api_store_file();
...
public:
	api_load_file(local_peer &local_peer, api_connection &connection);
	~api_load_file();
